        ...
        <div className="card-body">
          ...
          <div className="table-wrap">
            <table className="data-table">
              <thead><tr><th style={{ width: 34 }} /><th>Dato</th><th>Navn</th><th>Kontakt</th><th>Besked</th><th>Kilde</th><th>Status</th></tr></thead>
              <tbody>
                {leads.length === 0 ? (
                  <tr><td colSpan={7}><div className="table-empty">Ingen emner</div></td></tr>
                ) : leads.map((l) => {
